...
- ユビキタス言語: `docs/specs/ubiquitous-language.md`
  - 役割: 開発者同士およびコーディングエージェントとの会話で使うドメイン用語の正本
  - 参照タイミング: 実装指示、設計相談、Issue 記述、レビューコメントで用語を揃えたいとき
  - 変更タイミング: ドメイン用語を追加・変更したとき、または会話で使う名称を見直したとき
...
- 開発中につき、互換性は無視すること
- 必然性のないオプショナルの禁止。オプショナルを利用する場合、その理由説明をすること
- 必然性のないフォールバックの禁止。フォールバックを利用する場合、その理由説明をすること

...
// Background: Focused area operations share validation and graph rebuilding separate from membership basics.
// Responsibility: Apply focused-area mode and edge-style mutations while preserving area invariants.

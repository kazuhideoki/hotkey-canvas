...
- 2026-03-07: `CanvasCommand.alignSelectedNodes(.horizontal/.vertical)` を追加し、Command Palette から Diagram エリア内の複数選択ノードを focused node 基準で横整列・縦整列できるよう更新。キーマップは割り当てず、Command Palette 専用コマンドとして扱う。
